...
exports.default = EventsRenderer;
...
function renderEnum(prop) {
	if (!Array.isArray((0, _utils.getType)(prop).value)) {
		return _react2.default.createElement(
			'span',
			null,
			(0, _utils.getType)(prop).value
		);
	}

	var values = (0, _utils.getType)(prop).value.map(function (_ref) {
		var value = _ref.value;
		return _react2.default.createElement(
			_Code2.default,
			{ key: value },
			(0, _utils.showSpaces)((0, _utils.unquote)(value))
		);
	});
	return _react2.default.createElement(
		'span',
...
function renderExtra(prop) {
	var type = (0, _utils.getType)(prop);
...
function renderUnion(prop) {
	...
	var values = (0, _utils.getType)(prop).value.map(function (value, index) {
		return _react2.default.createElement(
			_Type2.default,
...
function renderTypeColumn(prop) {
	return _react2.default.createElement(
		_Type2.default,
		null,
		renderType((0, _utils.getType)(prop))
	);
}
